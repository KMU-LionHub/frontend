...
- AI 기반 발언 맥락 분석
- 모호한 단어 구간별 맥락 후보 표시
- AI 후보·직접 입력·무시 방식의 맥락 확정
- 계정별 서버 대화 기록·발언 상세·분석 이력 조회
- 진행 중인 서버 대화 이어가기
...
1. 회원가입 또는 로그인
2. 브라우저 마이크 권한 허용
3. 녹음 화면에서 대화 제목·배경·참여자 설정
4. 대화 시작 후 이번 발언 화자 선택
5. 마이크 버튼 클릭 후 음성 입력
6. 녹음 종료 및 STT 변환 결과 확인
7. 단어별 전사 결과 확인 및 교정
8. 필요하면 전체 발언 재녹음
9. AI 분석 시작
10. 모호한 단어 구간별 후보 확인
11. AI 후보·직접 입력·무시 중 하나로 각 구간 확정
12. 현재 발언 확정
13. 다음 화자를 선택해 발언 반복
14. 마지막 발언 확정 후 대화 종료
15. 대화 기록 화면에서 서버에 저장된 대화·발언 확인
16. 진행 중인 대화는 마지막 초안부터 이어가기
