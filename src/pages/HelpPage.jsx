...
function HelpPage() {
  const guides = [
    ...
    },
    {
      ...
      description:
        "모호한 단어 구간마다 AI 후보, 직접 입력, 무시 중 하나를 선택합니다. 모든 구간을 확정한 뒤 다음 화자의 발언을 이어서 녹음할 수 있습니다.",
    },
    {
      icon: History,
      title: "6. 대화 종료와 기록",
      description:
        "마지막 발언을 확정하고 대화를 종료합니다. 서버에 저장된 대화와 발언별 분석은 기록 메뉴에서 확인하고, 진행 중인 대화는 이어갈 수 있습니다.",
    },
  ];
